...
('05', 'Antioquia'),
('08', 'Atlántico'),
('11', 'D.C.'), -- Distrito Capital de Bogotá
('13', 'Bolívar'),
('15', 'Boyacá'),
('17', 'Caldas'),
('18', 'Caquetá'),
...
-- Inserts para dane_municipalities (Municipios de Colombia según DANE)
-- NOTA: Esta lista es extensa, solo se incluyen algunos ejemplos para cada departamento
-- y se asume que se generaría la lista completa a partir del PDF.
-- Para la lista completa, se necesitaría un script de parsing más robusto.
...
-- *****************************************************************************
-- PASO 4: ACTUALIZACIÓN DE DATOS EXISTENTES CON CÓDIGOS DANE
-- *****************************************************************************

-- Actualizar state_or_regions con los códigos DANE de departamentos
UPDATE state_or_regions
SET dane_department_code = CASE name
    WHEN 'Amazonas' THEN '91'
    WHEN 'Antioquia' THEN '05'
    WHEN 'Arauca' THEN '81'
    WHEN 'Atlántico' THEN '08'
    WHEN 'Bolívar' THEN '13'
    WHEN 'Boyacá' THEN '15'
    WHEN 'Caldas' THEN '17'
    WHEN 'Caquetá' THEN '18'
    WHEN 'Casanare' THEN '85'
    WHEN 'Cauca' THEN '19'
    WHEN 'Cesar' THEN '20'
    WHEN 'Chocó' THEN '27'
    WHEN 'Cundinamarca' THEN '25'
    WHEN 'Córdoba' THEN '23'
    WHEN 'Distrito Capital de Bogotá' THEN '11'
    WHEN 'Guainía' THEN '94'
    WHEN 'Guaviare' THEN '95'
    WHEN 'Huila' THEN '41'
    WHEN 'La Guajira' THEN '44'
    WHEN 'Magdalena' THEN '47'
    WHEN 'Meta' THEN '50'
    WHEN 'Nariño' THEN '52'
    WHEN 'Norte de Santander' THEN '54'
    WHEN 'Putumayo' THEN '86'
    WHEN 'Quindío' THEN '63'
    WHEN 'Risaralda' THEN '66'
    WHEN 'San Andrés, Providencia y Santa Catalina' THEN '88'
    WHEN 'Santander' THEN '68'
    WHEN 'Sucre' THEN '70'
    WHEN 'Tolima' THEN '73'
    WHEN 'Valle del Cauca' THEN '76'
    WHEN 'Vaupés' THEN '97'
    WHEN 'Vichada' THEN '99'
    ELSE NULL -- Para estados/regiones que no sean de Colombia o no tengan un mapeo DANE
END
WHERE country_id = '170'; -- Solo para registros de Colombia
